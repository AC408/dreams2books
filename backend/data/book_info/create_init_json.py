...
MIN_REVIEW_HELPFULNESS = (
    0.6  # Each review has to be at least MIN_REVIEW_HELPFULNESS helpful
)
...
MAX_REVIEW_COUNT_PER_BOOK = 10  # Max number of reviews per book to conserve space

path_to_books_data = (
    "~/Downloads/archive/books_data.csv"  # ~/Downloads/archive/books_data.csv
)
...
for k in range(num_splits):
    # save as json
    with open(root_path + "/data/book_info/data_" + str(k) + ".json", "w") as json_file:
        json.dump(
